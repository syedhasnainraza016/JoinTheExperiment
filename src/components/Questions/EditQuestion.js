...
export default function EditQuestion({ initialData, open, onClose, }) {
 ...
 let navigate=useNavigate()
  ...
  useEffect(() => {
    ...
    if (initialData) {
      console.log("initialData", initialData);
      formik.setFieldValue("question", initialData.question);
      formik.setFieldValue("status", initialData.status);
