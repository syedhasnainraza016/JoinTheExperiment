...
import { createTranslation,getTranslation ,updateTranslation} from "../../redux/actions/translationActions";
...
export default function EditTranslation({ initialData, open, onClose, }) {
...
const validationSchema = yup.object().shape({
  ...
  const onSubmit = (values, { resetForm }) => {
    ...
    dispatch(updateTranslation(values))
  ...
  useEffect(() => {
    ...
    if (initialData) {
      console.log("initialData", initialData);
      formik.setFieldValue("text", initialData.text);
      formik.setFieldValue("translate", initialData.translate);
      formik.setFieldValue("language", initialData.language);
