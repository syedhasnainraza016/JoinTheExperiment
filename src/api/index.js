...
export const createQuestion = (data) =>
  axios.post(`${url}/question/add-question`, data);
...
export const getTranslation = () =>
  axios.get(`${url}/translation/get-translations`);
export const updateTranslation = (data) =>
  axios.post(`${url}/translation/edit-translation`, data);
export const deleteTranslation = (id) =>
  axios.delete(`${url}/translation/del-translation/${id}`);
...
export const rateAnswer = (data) =>
  ...
  axios.post(`${url}/answer/checkAnswer`, data);
  
  export const ratingRecord = (data) =>
  axios.post(`${url}/answer/ratingRecord`, data);
